...
## Using the Torke Design Tool

Torke's [EN 1992-4 Design Tool](/design) automates this entire process. Input your anchor product, geometry, concrete properties, and loading -- the tool calculates all seven failure modes, applies the correct partial safety factors, checks the combined interaction, and identifies the governing failure mode.
